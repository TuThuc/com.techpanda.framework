...
public class GlobalConstants {
    ...
    public static final String UPLOAD_FILE = getFolerSaparator("uploadFiles");
    public static final String OS_NAME = System.getProperty("os.name");
    public static final String JAVA_VERSION = System.getProperty("java.version");
    public static final String DOWNLOAD_FILE =getFolerSaparator("downloadFiles");
    public static final String BROWSER_LOG = getFolerSaparator("browserLogs");
    public static final String DRAG_DROP_HTML5 = getFolerSaparator("dragDropHTML5 ");
    public static final String AUTO_IT_SCRIPT = getFolerSaparator("autoIT" );
...
private static String getFolerSaparator(String folderName){
